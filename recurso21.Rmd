...
También es posible determinar si existen problemas de sistematización en los datos, como se presenta en la variable `ubicacion` de la base de datos `Cali` construida a partir de la información de Covid-19 ubicada en Datos abiertos. 
...
En ella se resalta la mayor participación de los países afiliados a la UEFA (13), los cuales representan un 41.9% del total de países que participaron, seguido de la CFA y AFC cada uno con un 16.1% de participación.
...
<center>
**Tabla 1.2** : Nivel de satisfacción usuarios aerolinea, servicio de alimentación/bebidas a 
</center>
