...
# variables <- c("Edad", "Antigüedad", "Antigüedad_Cargo", "Años_ultima_promoción", "Años_a_cargo_con_mismo_jefe")
datos = datos[, c(2,18,21,22,23,24)] # se seleccionan variables de interes para facilitar su visualización
...
Esta transformación escala los valores de una variable a un rango específico, por defecto el rango es [0,1]. Se presenta cuando las variables no siguen una distribución normal, haciendo que las variable tengan el mismo rango. También se conoce con el nombre de  **min-max scaling**.
